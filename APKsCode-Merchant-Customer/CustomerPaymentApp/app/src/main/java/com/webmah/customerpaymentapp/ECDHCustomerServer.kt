...
import kotlinx.android.synthetic.main.activity_ecdhcustomerserver.*
...
class ECDHCustomerServer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ecdhcustomerserver)
    ...
    private fun generateECKeys() {
        ...
        client_pri.text = "Customer EC Private Key: $prkey"
        client_pub.text = "Customer EC Public Key: $pkey"
    ...
    private fun getServerECPublicKey() {
        ...
        if (checkNetworkConnection()) {
            ...
            lifecycleScope.launch {
                val result = httpPost("https://webmah.com/customerpaymentapp/ServerAuthAtClient.php", jsonObject)
                ...
                server_pub.text = "Bank Server EC Public Key: $spkey"
    ...
    private fun verifyClintAtServer() {
        ...
        if (checkNetworkConnection()) {
            ...
            lifecycleScope.launch {
                val result = httpPost("https://webmah.com/customerpaymentapp/ClientAuthAtServer.php", jsonObject)
    ...
    private fun showAuthenticationScreen() {
        ...
        val intent: Intent? = keyguardManager.createConfirmDeviceCredentialIntent("User Authentication",
            "To be able to use this Smart Meter Secure App we need to confirm your identity. Please enter your pin/pattern or scan your fingerprint")
        if (intent != null) {
...
private const val SHAREDLOCATION = "CUSTOMERPAYMENTAPP"