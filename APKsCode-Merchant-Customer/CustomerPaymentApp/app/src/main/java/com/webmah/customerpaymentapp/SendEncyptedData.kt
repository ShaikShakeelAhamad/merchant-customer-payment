...
class SendEncyptedData  : AppCompatActivity() {
    ...
    private fun encryptAndSend() {
        ...
        if (checkNetworkConnection()) {
            ...
            lifecycleScope.launch {
                val result = httpPost("https://webmah.com/customerpaymentapp/NFCPaymentSimulation.php", jsonObject)
            }
        }
        else
    ...
    private fun showAuthenticationScreen() {
        ...
        val intent: Intent? = keyguardManager.createConfirmDeviceCredentialIntent("User Authentication",
            "To be able to use this Customer Payment App we need to confirm your identity. Please enter your pin/pattern or scan your fingerprint")
        if (intent != null) {
