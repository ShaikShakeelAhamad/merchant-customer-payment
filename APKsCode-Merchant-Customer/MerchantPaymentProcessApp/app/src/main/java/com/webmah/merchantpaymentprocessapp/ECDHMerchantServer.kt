...
import kotlinx.android.synthetic.main.activity_ecdhmerchantserver.*
...
class ECDHMerchantServer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ecdhmerchantserver)
        ...
        accessApp.setOnClickListener {
            val intent = Intent(this, MerchantInfo::class.java)
    ...
    private fun generateECKeys() {
        ...
        client_pri.text = "Merchant EC Private Key: $prkey"
        client_pub.text = "Merchant EC Public Key: $pkey"
